...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddNotificationServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // Add MongoDB with optimized connection pooling
        services.AddOptimizedMongoDB(configuration);

        // Add Redis with optimized connection pooling
        services.AddOptimizedRedis(configuration);

        // Add RabbitMQ with optimized connection pooling
        services.AddOptimizedRabbitMQ(configuration);
